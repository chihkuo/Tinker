...
then
	...
	sudo cp -f /home/linaro/init/configs/hostapd.conf /etc/hostapd/hostapd.conf
	echo "copy apboot.sh"
...
then
	...
	sudo cp -f /home/linaro/init/configs/wpa_supplicant.conf /etc/wpa_supplicant/wpa_supplicant.conf
