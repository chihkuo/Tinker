...
#define CSID_C_REMOTE_AP_SMS_PHONE_NUMBER		_CFG_REMOTE(0x0016)  //T=str, phone number of SMS alert			
...
#define CSID_C_REMOTE_AP_ALERT_NOTIFY_APDISCONNECT	_CFG_REMOTE(0x0226)  //T=u8, D=0, enable notify alert, 0:disable, 1:alert 1, 2alert 2, 3: alert 3, 4: alert 4, 5: alert 5
...
//for AP Job Scheduling
#define CSID_C_REMOTE_AP_SCHEDULING_RULE_NAME		_CFG_REMOTE(0x0250) //T=str, AP job scheduling rule name
#define CSID_C_REMOTE_AP_SCHEDULING_RULE		_CFG_REMOTE(0x0270)	//T=u32, index of scheduling rule
#define CSID_C_REMOTE_AP_SCHEDULING_ASSIGN_JOB		_CFG_REMOTE(0x0290) //T=u8, assign job of scheduling rule
#define CSID_C_REMOTE_AP_SCHEDULING_FW		_CFG_REMOTE(0x02B0) //T=str, firmware for scheduling rule
#define CSID_C_REMOTE_AP_SCHEDULING_FW_ROMID		_CFG_REMOTE(0x02D0) //T=str, firmware ROMID for scheduling rule
#define CSID_C_REMOTE_AP_SCHEDULING_TIME		_CFG_REMOTE(0x0300) //T=str, record the time of triggered schedule rule
#define CSID_C_REMOTE_AP_SCHEDULING_RECORD		_CFG_REMOTE(0x0320) //T=str, record the ap job execution of triggered schedule rule, 0:not done, 1:done, X:not apply
#define CSID_C_REMOTE_AP_SCHEDULING_RULE_OLD		_CFG_REMOTE(0x0340) //T=u32, index of scheduling rule before edit
...
//for AP Job Scheduling
#define CSID_S_REMOTE_AP_TRUSTAP_SCHEDULE		_STA_REMOTE(0x1280) //T=u32, using bit for present rule applying
#define CSID_S_REMOTE_AP_TRUSTAP_SCHEDULE_TRIGGER_STATUS		_STA_REMOTE(0x1300) //T=u32, schedule rule trigger status
#define CSID_S_REMOTE_AP_TRUSTAP_SCHEDULE_TRIGGER_STATUS_OLD		_STA_REMOTE(0x1320) //T=u32, schedule rule trigger status
#define CSID_S_REMOTE_AP_TRUSTAP_SCHEDULE_FWUPLOAD_ALTER		_STA_REMOTE(0x1340) //T=u32, firmware upload alter for AP job scheduling 		
...
//AP disconnect
#define CSID_S_REMOTE_AP_DISCONNECT_TIMES		_STA_REMOTE(0x3500)  //T=u32, the times of AP offline status 
...
//for AP Job Scheduling
#define CSID_S_REMOTE_AP_SCHEDULING_ENABLE	_STA_REMOTE(0x6207)  //T=u32, D=0, Trigger UI to enable AP job scheduling 
