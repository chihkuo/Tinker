...
/* for selectable card */
#define CSID_C_WLANAP_OPERATED_BAND         _CFG_WLANAP(0x0012) //T=u8, D=0, operation band for each module, 0: 2.4G, 1: 5G
#define CSID_C_WLANAP_SEL_SUPPORT           _CFG_WLANAP(0x0013) //T=u8, D=0, module supports selectable feature, 0: not supportable, 1: supportable
...
#define CSID_C_WLANAP_WSC_DISABLE_WSCD  _CFG_WLANAP(0xa309) //T=u8, D=0, set 1 to disable wscd
...
#define CSID_C_WLANAP_IEEE80211H_ENABLE 	_CFG_WLANAP(0xaf00) //T=u8, D=1, enable/disable 5G DFS, if apcli is enable, thsi para must be 0
...
#define CSID_C_WLANAP_CLIENT_RSSI_THRESHOLD	_CFG_WLANAP(0xba01) //T=u32, D=0
#define CSID_C_WLANAP_CLIENT_5G_MAXIMUM		_CFG_WLANAP(0xba02) //T=u32, D=0
#define CSID_C_WLANAP_RSSI_ENABLE				_CFG_WLANAP(0xba05) //T=u32, D=0
...
#define CSID_C_WLANAP_AP_AIR_BANDWIDTH	_CFG_WLANAP(0xbb12) //T=u32, D=0
#define CSID_C_WLANAP_ANTENNA_TYPE			_CFG_WLANAP(0xbb13) //T=u32, D=0, to change antenna type, 0: internal, 1: SMA connector
...
//WLAN UI TX POWER LIMITE
#define CSID_S_WLANAP_UIPOWER_NOLIMITE		_STA_WLANAP(0xb70c) //T=u8, D=0, wifi UI TX Power

//WLAN WPS
#define CSID_S_WLANAP_WPS_SCRIPT_STATUS		_STA_WLANAP(0xb70d) //T=u8, D=0, wifi wps script status

//WLAN UI TX POWER DISPLAY LIMITE
#define CSID_S_WLANAP_UIPOWER_DISPLAYLIMITE		_STA_WLANAP(0xb70e) //T=u8, D=0, wifi UI TX Power

//WLAN UI TX HIGH POWER 
#define CSID_S_WLANAP_HIGH_POWER		_STA_WLANAP(0xb70f) //T=u8, D=0, wifi UI TX Power
