...
#define CSID_C_SNMP_ENTERPRISE_NAME					_CFG_SNMP(0x00ae) //T=str, D="AMIT",enterprise name, e.g. AMIT
#define CSID_C_SNMP_ENTERPRISE_NUMBER				_CFG_SNMP(0x00af) //T=str, D="12823",enterprise number, e.g. 12823
...
#define CSID_C_SNMP_MTN_TRAP_SERVER_PORT			_CFG_SNMP(0x5200)	//T=u32, D=162,snmp trap server port
