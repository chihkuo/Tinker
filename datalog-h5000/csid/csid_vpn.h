...
#define CSID_C_IPSEC_DYN_TUN_NUM                    _CFG_VPN(0xB200) //T=u32, D=0, Max number of dynamic IPsec client,0: Default max 32 client , MAX value is 256
...
#define CSID_S_IPSEC_NAT_ALTERED                                                  _STA_VPN(0x000B) //T=u32, D=0, 1:IPsec nat rule need to restart
#define CSID_S_IPSEC_DYN_4_TUNNELS                                                _STA_VPN(0x000C) //T=u32, total active dynamic_4 tunnels
...
#define CSID_S_IPSEC_DYN_4_CLIENTS                      _STA_VPN(0x3700) //T=ipv4, Dynamic_4 IPSec client IPv4 list
#define CSID_S_IPSEC_DYN_4_CLIENTS_MASK                 _STA_VPN(0x3800) //T=ipv4, Dynamic_4 IPSec client subnet mask list
#define CSID_S_IPSEC_DYN_4_CLIENTS_GW                   _STA_VPN(0x3900) //T=ipv4, Dynamic_4 IPSec client gateway list
