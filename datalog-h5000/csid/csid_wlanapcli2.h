...
#define CSID_C_WLANAPCLI2_SAVED_AP_QUALITY    _CFG_WLANAPCLI2(0xa410) //T=u8, Saved AP Signal Quality
#define CSID_C_WLANAPCLI2_SAVED_AP_PRIORITY   _CFG_WLANAPCLI2(0xa420) //T=u8, D=16, User-defined priority of Saved AP
#define CSID_C_WLANAPCLI2_SAVED_AP_ENABLE	  _CFG_WLANAPCLI2(0xa430) //T=u8, D=1, Disable(0)/Enable(1) Saved AP

#define CSID_C_WLANAPCLI2_CONFIGBYWPS		  _CFG_WLANAPCLI2(0xa500) //T=u8, D=0, if user configed by wpsapcv2-action

/* APCli Profile status */
#define CSID_C_WLANAPCLI2_PROFILE_ENABLE	  _CFG_WLANAPCLI2(0xa501) //T=u8, D=0, disable(0)/enable(1) Profile function.
#define CSID_C_WLANAPCLI2_PRIORITY_METHOD	  _CFG_WLANAPCLI2(0xa502) //T=u8, D=0, Priority method of profile. Signal Strength(0)/User-defined(1)

/* ROAMING CHECK */
#define CSID_C_WLANAPCLI2_ROAM_ENABLE        	_CFG_WLANAPCLI2(0xa600) //T=u8, D=0, enable/disable roaming check function
#define CSID_C_WLANAPCLI2_ROAM_INTERVAL   _CFG_WLANAPCLI2(0xa700) //T=u32, D=1000, Set roaming check interval default 1000ms
#define CSID_C_WLANAPCLI2_ROAM_QUALITY    _CFG_WLANAPCLI2(0xa800) //T=u32, D=180, Set roaming check quality default 30
...
#define CSID_S_WLANAPCLI2_SIGNAL_ACCESSOK	 _STA_WLANAPCLI2(0x000d)  //T=u8, D=0, Scan signal strengh not yet(0)/complete(1).
#define CSID_S_WLANAPCLI2_PROFILE_STATUS	 _STA_WLANAPCLI2(0x000e)  //T=str, Display profile name which the apcli connect with.
