...
/* DHCP SERVER OPTIONS 0x3000~0x3fff */
/* 0x3000 DHCP SERVER OPTIONS ENABLE */
/* 0x3100~0x31ff */
#define CSID_C_DHCP_SVR_OPTIONS_ENABLE		      _CFG_DHCP(0x3000)	//T=u8, D=0, DHCP server options Enable(1)/Disable(0)
#define CSID_C_DHCP_SVR_OPTIONS_ENTRY_NAME        _CFG_DHCP(0x3100)	//T=str
#define CSID_C_DHCP_SVR_OPTIONS_ENTRY_SERVER      _CFG_DHCP(0x3200)	//T=str, server name's csid address, ex.0003000f 
#define CSID_C_DHCP_SVR_OPTIONS_ENTRY_OPTION      _CFG_DHCP(0x3300)	//T=u8, 66 72 114 
#define CSID_C_DHCP_SVR_OPTIONS_ENTRY_VALUE_TYPE  _CFG_DHCP(0x3400)	//T=u8, 0=ip 1=ip-list 2=fqdn 3=url
#define CSID_C_DHCP_SVR_OPTIONS_ENTRY_VALUE       _CFG_DHCP(0x3500)	//T=str, ip | ip-list(space seperate) | fqdn | url
#define CSID_C_DHCP_SVR_OPTIONS_ENTRY_ENABLE      _CFG_DHCP(0x3600)	//T=u8, D=0, DHCP server options entry Enable(1)/Disable(0)
/* Basic Setting end */
