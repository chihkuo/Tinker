...
#define CSID_S_USB_CNT_IF_NAME_IPV6     _STA_USB(0x0300)  //T=str, connect interface name, ppp, usbnet, wwan for IPv6
...
/* Status Items */
#define CSID_S_USB_MANUFACTURER         _STA_USB(0x0260)  //T=str, USB manufacturer name
#define CSID_S_USB_SPEED                _STA_USB(0x0270)  //T=str, USB speed, ex. 1.10, 2.00

/* to specify the module loaded driver qmi_wwan */
#define CSID_S_USB_ME909U_LOAD_QMI_WWAN _STA_USB(0x0280)  //T=u8, D=0, Huawei ME909u load driver qmi_wwan
