...
//HW SIM detect
#define CSID_C_3G_HW_SIM_DETECT_SUPPORT     _CFG_3G(0x0099) //T=u32, D=0, 0:disable 1:enable, to support HW SIM detect
...
#define CSID_C_3G_SMS_REMOTE_MG_CMD_DTR_ENABLE			_CFG_3G(0x254f)	//T=u8, D=0 , 0:disable, 1:enable, enable sms set dtr pin
...
#define CSID_C_3G_SMS_REMOTE_MG_SECURITY_KEY_ENABLE          _CFG_3G(0x2592) //T=u8, D=0, SMS remote management security key enable, 0: disable, 1: enable
...
#define CSID_C_3G_SMS_REMOTR_MG_ACCESS_CTL_RANGE_MCC_CODE	_CFG_3G(0x3780)	//T=str, SMS MG access control mcc code
...
#define CSID_C_3G_DELETE_INVAILD_PHONE_SMS_ENABLE	_CFG_3G(0x6e85) //T=u32, D=0, sms event management current 3G interface
...
#define CSID_S_3G_MULTIWAN_SINR              _STA_3G(0x2be0) //T=s32, signal-to-interference-plus-noise ratio
...
#define CSID_S_3G_MULTIWAN_EVENT_MANAGEMENT_ALERT			_STA_3G(0x2c60) //T=u8, D=0 ,let event management deamon to work
//Just remind next start from 2d00
...
#define CSID_S_3G_NOTIFY_STATUS			 		_STA_3G(0x4100)  //T=u32,D=0, 0:3g_notifyd not ready, 1:3g_notifyd ready
...
#define CSID_S_3G_NEED_CHECK_IPV6_ADDR_RECV     _STA_3G(0x5080) //T=u32, D=0, 1: need to check, 2: not care
...
#define CSID_S_3G_SMS_REMOTE_MG_NOTIFY_DATA_USAGE_80			_STA_3G(0x6011) //T=u32, DATA_USAGE_80%
#define CSID_S_3G_SMS_REMOTE_MG_NOTIFY_DATA_USAGE_100			_STA_3G(0x6012) //T=u32, DATA_USAGE_100%
...
#define CSID_S_3G_HW3131		_STA_3G(0x8221) //T=u32, Flag to power ON/OFF
