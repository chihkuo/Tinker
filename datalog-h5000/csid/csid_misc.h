...
#define CSID_C_MISC_PING_TARGET_VERSION              _CFG_MISC(0x009F)	//T=u8, D=0, IP version for ping test, 0:IPv4, 1:IPv6
...
/*Dashboard Range: 0x780~0x7BF(size:64)*/
#define CSID_C_MISC_DASHBOARD_EN             _CFG_MISC(0x0780)   //T=u32, D=0, Enable dashboard or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_DEBUG          _CFG_MISC(0x0781)   //T=u32, D=0, Enable dashboard debug or not? 1:console, 2:syslog, 0:disable
#define CSID_C_MISC_DASHBOARD_CURRENT_EN     _CFG_MISC(0x0782)   //T=u32, D=0, Enable dashboard current item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_CPU_EN         _CFG_MISC(0x0783)   //T=u32, D=0, Enable dashboard cpu item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_MEM_EN         _CFG_MISC(0x0784)   //T=u32, D=0, Enable dashboard mem item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_WAN_EN         _CFG_MISC(0x0785)   //T=u32, D=0, Enable dashboard wan item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_BOND_EN        _CFG_MISC(0x0786)   //T=u32, D=0, Enable dashboard bond item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_LAN_EN         _CFG_MISC(0x0787)   //T=u32, D=0, Enable dashboard lan item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_WIFI_24G_EN    _CFG_MISC(0x0788)   //T=u32, D=0, Enable dashboard wifi 2.4G item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_WIFI_5G_EN     _CFG_MISC(0x0789)   //T=u32, D=0, Enable dashboard wifi 5G   item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_AP_EN          _CFG_MISC(0x078A)   //T=u32, D=0, Enable dashboard ap item or not? 1: enable, 0:disable
#define CSID_C_MISC_DASHBOARD_ALLAP_EN       _CFG_MISC(0x078B)   //T=u32, D=0, Enable dashboard allap item or not? 1: enable, 0:disable

/*Lan access for remote admin*/
#define CSID_C_MISC_REMOTE_ADMIN_LAN_DISABLE 		_CFG_MISC(0x0900)	//T=u32, D=0, disable remote admin lan access for http, 1:enable, 0:disable
#define CSID_C_MISC_HTTPS_REMOTE_ADMIN_LAN_DISABLE	_CFG_MISC(0x0910)	//T=u32, D=0, disable remote admin lan access for https, 1:enable, 0:disable 
...
#define CSID_C_MISC_WAN_PHY_RX_PKT_CHK_ENABLE           _CFG_MISC(0x2200)       //T=u32, WAN Physical Interface RX Packets Checking Enable
#define CSID_C_MISC_WAN_PHY_RX_PKT_CHK_INTERVAL_TIME    _CFG_MISC(0x2201)       //T=u32, WAN Physical Interface RX Packets Checking Interval Time (Unit: Seconds)

#define CSID_C_MISC_AUTOBACKUP_ENABLE		_CFG_MISC(0x2300)	//T=u8, rule enable, 1:yes 0:no
#define CSID_C_MISC_AUTOBACKUP_EVENT		_CFG_MISC(0x2301)	//T=u8, event trigger, 1:yes 0:no

#define CSID_C_MISC_TCPKEEPALIVE_ENABLE		_CFG_MISC(0x2400)	//T=u8, D=0, tcpkeeplive enable, 1:enable, 0:disable
#define CSID_C_MISC_TCPKEEPALIVE_PORT		_CFG_MISC(0x2401)	//T=u32, D=0, tcpkeep alive socket port
#define CSID_C_MISC_TCPKEEPALIVE_ACCESS_IP	_CFG_MISC(0x2402)	//T=ipv4, tcpkeep alive access ip
#define CSID_C_MISC_TCPKEEPALIVE_NM		_CFG_MISC(0x2403)	//T=u32, tcpkeep alive netmask
...
#define CSID_S_MISC_LAN_PKT_IN			    _STA_MISC(0x0014)	//T=u32, number of incoming packet of lan
#define CSID_S_MISC_LAN_PKT_OUT			    _STA_MISC(0x0015)	//T=u32, number of outgoing packet of lan
#define CSID_S_MISC_WAN_BYTE_IN			    _STA_MISC(0x0016)	//T=u32, number of incoming bytes of wan
#define CSID_S_MISC_WAN_BYTE_OUT			_STA_MISC(0x0017)	//T=u32, number of outgoing bytes of wan
#define CSID_S_MISC_LAN_BYTE_IN			    _STA_MISC(0x0018)	//T=u32, number of incoming bytes of lan
#define CSID_S_MISC_LAN_BYTE_OUT			_STA_MISC(0x0019)	//T=u32, number of outgoing bytes of lan
#define CSID_S_MISC_TRACERT_TARGET_TYPE     _STA_MISC(0x001A)   //T=u8, 0: WAN, 1:LAN, 2-4:VLAN1-3
...
/*login*/
#define CSID_S_MISC_TELNET_LOGIN_RETRY  _STA_MISC(0x0025)   //T=u8, D=0, telnet login retry times(max: 3)
#define CSID_S_MISC_SSH_LOGIN_RETRY     _STA_MISC(0x0026)   //T=u8, D=0, ssh login retry times(max: 10)
#define CSID_S_MISC_CONSOLE_LOGIN_RETRY _STA_MISC(0x0027)   //T=u8, D=0, console login retry times(max: 3)
...
#define CSID_S_MISC_DCH_REBOOT_ALTER  		_STA_MISC(0x0346)	//T=u32, D=0, DCH type 1:A/C 2:dehumidifier
...
/*Dashboard Range  0x0430~0x043F*/
#define CSID_S_MISC_DASHBOARD_CURRENT_RD_EN      _STA_MISC(0x0430)   //T=u32, D=0, Enable dashboard current item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_CPU_RD_EN          _STA_MISC(0x0431)   //T=u32, D=0, Enable dashboard cpu item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_MEM_RD_EN          _STA_MISC(0x0432)   //T=u32, D=0, Enable dashboard mem item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_WAN_RD_EN          _STA_MISC(0x0433)   //T=u32, D=0, Enable dashboard wan item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_BOND_RD_EN         _STA_MISC(0x0434)   //T=u32, D=0, Enable dashboard bond item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_LAN_RD_EN          _STA_MISC(0x0435)   //T=u32, D=0, Enable dashboard lan item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_WIFI_24G_RD_EN     _STA_MISC(0x0436)   //T=u32, D=0, Enable dashboard wifi 2.4G item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_WIFI_5G_RD_EN      _STA_MISC(0x0437)   //T=u32, D=0, Enable dashboard wifi 5G   item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_AP_RD_EN           _STA_MISC(0x0438)   //T=u32, D=0, Enable dashboard ap item output to XML file or not? 1: enable, 0:disable
#define CSID_S_MISC_DASHBOARD_ALLAP_RD_EN        _STA_MISC(0x0439)   //T=u32, D=0, Enable dashboard allap item output to XML file or not? 1: enable, 0:disable

#define CSID_S_MISC_DASHBOARD_WRITING		_STA_MISC(0x043F)	//T=u8, D=0, indicate if dashboard file is writing

#define CSID_S_MISC_AUTOBACKUP_SAVE_STATUS	_STA_MISC(0x0440)	//T=u8, D=0, save status, 1:sucess 2:failed
#define CSID_S_MISC_LOGOUPLOAD_STATUS		_STA_MISC(0x0441)	//T=u8, D=0, logoupload status
#define CSID_S_MISC_CONFIG_SAVE			_STA_MISC(0x0442)	//T=u8, D=0, save config, 1:WebUI, 2:USB
#define CSID_S_MISC_AUTOBACKUP_SAVE		_STA_MISC(0x0443)	//T=u8, D=0, save autobackup config, 1:save

/*TCP keep alive*/
#define CSID_S_MISC_TCPKEEPALIVE_ALTER		_STA_MISC(0x0500)      //T=u8, D=0, alter for restart keep alive
