...
//do nothing
#define CSID_C_X509_SCEP_ENROLL_SVR_IP	            	_CFG_X509(0x7900) //T=str, scep enrollment server ip
#define CSID_C_X509_SCEP_ENROLL_SVR_PORT	        	_CFG_X509(0x7A00) //T=u32, D=0, scep enrollment server port
#define CSID_C_X509_SCEP_ENROLL_PATH	            	_CFG_X509(0x7B00) //T=str, scep enrollment server path
#define CSID_C_X509_SCEP_ENROLL_APPLICATION	        	_CFG_X509(0x7C00) //T=str, scep enrollment application
