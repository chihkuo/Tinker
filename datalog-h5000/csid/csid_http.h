...
#define CSID_C_HTTP_AUTH_RETRY_MAX      _CFG_HTTP(0x0003) //T=u8, D=3, max login retry count(3~10)
...
/* HTTPS ONLY ENABLE */
#define CSID_C_HTTPS_ONLY_ENABLE      	_CFG_HTTP(0x01C1) //T=u32, 1:enable https only, 0:http & https both
...
#define CSID_S_HTTP_FWUPG_SECTION_ID    _STA_HTTP(0x0006) //T=u32, D=0, 1:FW, 2:Config
...
#define CSID_S_HTTP_SUPPORT_NEW_TOKEN   _STA_HTTP(0xF00b) //T=u32, D=0, support new token
