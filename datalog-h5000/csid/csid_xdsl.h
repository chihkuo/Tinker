...
#define CSID_S_XDSL_DATARATE_FAST_UP         _STA_XDSL(0x0027)       //T=str, FAST DATARATE up, if ADSL is down, value=N/A
#define CSID_S_XDSL_DATARATE_FAST_DOWN       _STA_XDSL(0x0028)       //T=str, FAST DATARATE down, if ADSL is down, value=N/A
