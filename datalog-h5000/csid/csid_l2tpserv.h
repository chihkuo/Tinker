...
#define CSID_C_L2TPSERV_WAN                          _CFG_L2TPSERV(0x001b)   //T=u32, D=0, 1:WAN1,2:WAN2,3:WAN3
...
#define CSID_C_L2TP_SERV_PASSCODE		    _CFG_L2TPSERV(0x0640) //T=str, CGI PASS CODE
#define CSID_C_L2TP_SERV_PASSCODE_RESV		_CFG_L2TPSERV(0x065F) //T=str, CGI PASS CODE
#define CSID_C_L2TP_SERV_QRCODE_TIME        _CFG_L2TPSERV(0x0660) //T=u32, D=7, QRCODE value
#define CSID_C_L2TP_SERV_USER_QRCODE_TIME1	_CFG_L2TPSERV(0x0661) //T=u32, User QR code time year,mon,day
#define CSID_C_L2TP_SERV_USER_QRCODE_TIME1_RESV		_CFG_L2TPSERV(0x066F) //T=u32, User QR code time
#define CSID_C_L2TP_SERV_USER_QRCODE_TIME2	_CFG_L2TPSERV(0x0671) //T=u32, User QR code time hour,min,sec
#define CSID_C_L2TP_SERV_USER_QRCODE_TIME2_RESV		_CFG_L2TPSERV(0x067F) //T=u32, User QR code time
...
#define CSID_S_L2TP_SERV_PRE_SHARE_KEY_ALT    _STA_L2TPSERV(0x0604)    //T=s32, D=0,pre share key alter
#define CSID_S_L2TP_SERV_AUTH_CGI_PORT        _STA_L2TPSERV(0x0605)    //T=s32, D=0,cgi port number
#define CSID_S_L2TPSERV_ACCOUNT_PASSWORD      _STA_L2TPSERV(0x0606)	 //T=str, user password
#define CSID_S_L2TP_SERV_PASSCODE		      _STA_L2TPSERV(0x0640) //T=str, CGI PASS CODE
#define CSID_S_L2TP_SERV_PASSCODE_RESV		  _STA_L2TPSERV(0x065F) //T=str, CGI PASS CODE
#define CSID_S_L2TP_SERV_USER_QRCODE_TIME1	  _STA_L2TPSERV(0x0661) //T=u32, User QR code time year,mon,day
#define CSID_S_L2TP_SERV_USER_QRCODE_TIME1_RESV		_STA_L2TPSERV(0x066F) //T=u32, User QR code time
#define CSID_S_L2TP_SERV_USER_QRCODE_TIME2	        _STA_L2TPSERV(0x0671) //T=u32, User QR code time hour,min,sec
#define CSID_S_L2TP_SERV_USER_QRCODE_TIME2_RESV		_STA_L2TPSERV(0x067F) //T=u32, User QR code time
