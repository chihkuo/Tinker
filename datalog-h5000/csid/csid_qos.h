...
/*For Telewell: CDW57CAM*/
#define CSID_C_QOSC_IGMP_WAN_BW         _CFG_QOS(0xc210) //T=u32, Range:1~1000, for UI. 
#define CSID_C_QOSC_SW_IGMP             _CFG_QOS(0xc220) //T=u16, 1:Remove HW_NAT and use TC to control igmp and tcp flow.

/* Status Items */
#define CSID_S_QOS_ALTERED              _STA_QOS(0x0001) //T=u8, ui altered
#define CSID_S_QOS_GROUPING_ALTERED     _STA_QOS(0x0002) //T=u8, ui altered for Grouping rule
/*Cross-Layer*/
...
#define CSID_S_QOSC_AP_NUM              _STA_QOS(0x0017) //T=u8, User number of AP Client.
...
#define CSID_S_QOSC_UG_LOGIN_IP         _STA_QOS(0x0700) //T=str, IP of Login user.
