...
/* write local time to flash */
#define CSID_C_BOOT_TIME_RECORD_ENABLE         _CFG_NTP(0x0050) //T=u32, Enable or Diasble write time to flash when no RTC
#define CSID_C_BOOT_TIME_RECORD         _CFG_NTP(0x0051) //T=str, set date time

/*3G modlue first*/
#define CSID_C_NTP_3G_MODLUE_FIRST         _CFG_NTP(0x0060) //T=u32, D=0, 3G MODLUE_FIRST
...
#define CSID_S_NTP_WITH_MODULE    _STA_NTP(0x0007) //T=u8, sync with module
#define CSID_S_NTP_TZ_ENVAR_WITH_MODULE    _STA_NTP(0x0008) //T=str, time zone with module
#define CSID_S_NTP_CURRENT_TIME_WITH_MODULE    _STA_NTP(0x0009) //T=str, current time with module
#define CSID_S_NTP_SYNC_FUNCTION    _STA_NTP(0x000A) //T=u8, 0=NTP, 1=3G1, 2=3G2
#define CSID_S_NTP_WITH_MODULE_ENABLE    _STA_NTP(0x000B) //T=u8, 0=disable, 1=enable
