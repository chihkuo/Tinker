...
#define CSID_C_SYS_SERIAL_NUM     _CFG_SYS(0x000F)   //T=u8, D=0, total numbers of Serial = value+1
/* usb storage*/
#define CSID_C_SYS_USB_STORAGE_ENABLE  _CFG_SYS(0x0010)    //T=u32, usb storage enable
/* device name*/
#define CSID_C_SYS_DEVICE_NAME	_CFG_SYS(0x0011)	//T=str, device name
/* config.bin name*/
#define CSID_C_SYS_CONFIG_BIN_NAME	_CFG_SYS(0x0012)	//T=str, config.bin name

#define CSID_C_SYS_CPU_TYPE     _CFG_SYS(0x0013)   //T=u8, D=0, CPU type 0:RT6856 1:MT7620 2:MT7621
#define CSID_C_SYS_ROUTER_TYPE	_CFG_SYS(0x0014)   //T=str, Router Type

/* UHS manually control LED*/
#define CSID_C_SYS_CONTROL_LED	_CFG_SYS(0x0020)	//T=u8, D=0, Control System LEDs 0:Auto, 1:Manual
...
/*DarfonLogger Parameter
#define CSID_C_SYS_DARFONLOGGER_DATALOGGER_SN           _CFG_SYS(0x0300)    //T=str, darfon sn
*/
...
#define CSID_S_SYS_KEY_NUMBER			_STA_SYS(0x4263) //T=str, define custormer key number
//==========================================================
...
/* FWUPG URL */
#define CSID_S_SYS_FWUPG_URL  		_STA_SYS(0x4284)   //T=str, fwupg url

/* FWUPG Status Show */
#define CSID_S_SYS_FWUPG_STATUS_SHOW  	_STA_SYS(0x4285)   //T=u32, fwupg status show
...
#define CSID_S_SYS_DATA_USAGE_USING_PERCENT         _STA_SYS(0x07c0)   //T=u32, D=0, data usage percent
...
//for mydlink
#define CSID_S_SYS_MYDLINK_UID          _STA_SYS(0xF530)    //T=str, mydlink UIDs
